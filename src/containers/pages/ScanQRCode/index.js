    ...
    return (
      <View style={{ flex: 1 }}>
        <View style={{ flex: 1, backgroundColor: 'grey' }}>
          ...
          />
          <View style={{
            flexDirection: 'row', paddingHorizontal: 16, marginTop: 16, justifyContent: 'space-between', position: 'absolute',
        ...
        <View style={{ height: 200, backgroundColor: '#fff', paddingHorizontal: 16 }}>
